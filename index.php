    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#pricing">Members</a></li>
          <li><a href="#">Blog</a></li>
  ...
  <section id="hero" class="d-flex justify-cntent-center align-items-center">
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">The call to the Nation</h2>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">The new era of Leadership</h2>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch" data-aos="fade-left">
            ...
            <div class="content">
              <h3>India is on verge of becoming <strong>Super power but how?</strong></h3>
              <!-- <p>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                ...
                <span>General Secretary ~ JU</span>
                <p>Computer science Engineer, with keen interest in Social Reforms</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
          ...
          <div class="col-lg-5">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Nandnagar Varanasi-221005 India</p>
              </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Subscribe to our newsletter to get the weekly updates directly into ur inbox</p>
          </div>
          <div class="col-lg-6">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
              Nandnagar, Karaundhi <br>
              Varanasi, UP 221005<br>
              India <br><br>
              <strong>Phone:</strong> +91 888-76-10230<br>
              <strong>Email:</strong> justuniteindia@gmail.com<br>
            </p>
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>Just Unite</h3>
            <p>It's a matter of great pride to serve your country. Incase you have the heart zeal to serve your nation India, we welcome you: Join us</p>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="#">Allied Infomedia</a>
      </div>
    </div>
  </footer><!-- End Footer -->
